...
if ( ! function_exists( 'woocommerce_template_loop_category_title' ) ) {
	...
	function woocommerce_template_loop_category_title( $category ) {
		?>
		<h2 itemprop="name" content="<?php
        echo esc_html( $category->name );?>" class="woocommerce-loop-category__title">
			<?php
...
if ( ! function_exists( 'woocommerce_template_loop_product_link_open' ) ) {
	...
	function woocommerce_template_loop_product_link_open() {
		...
		echo '<a itemprop="url" href="' . esc_url( $link ) . '" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">';
	}
}
...
if ( ! function_exists( 'woocommerce_template_loop_category_link_open' ) ) {
	...
	function woocommerce_template_loop_category_link_open( $category ) {
		echo '<a itemprop="url" href="' . esc_url( get_term_link( $category, 'product_cat' ) ) . '">';
	}
}
