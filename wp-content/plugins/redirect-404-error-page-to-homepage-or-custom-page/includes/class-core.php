...
class Core {
	...
	private function settings_pages() {
		...
		$activeblocks = new Admin_Table_404_Log( $this->get_plugin_name(), $this->get_version(), $this->freemius );
	...
	private function define_public_hooks() {
		 ...
		 * side of the site.
		 */
		$plugin_public = new FrontEnd( $this->get_plugin_name(), $this->get_version(), $this->freemius );
