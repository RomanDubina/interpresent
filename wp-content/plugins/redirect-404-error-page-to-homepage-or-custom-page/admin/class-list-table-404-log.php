...
class List_Table_404_log extends WP_List_Table {
	...
	public function __construct() {
		...
		parent::__construct( [
			'singular' => __( '404 Log Entry', 'redirect-404-error-page-to-homepage-or-custom-page' ), //singular name of the listed records
			'plural'   => __( '404 Log Entries', 'redirect-404-error-page-to-homepage-or-custom-page' ), //plural name of the listed records
