...
class Admin_Pages {
	...
	public function settings_setup() {
		...
		add_menu_page(
			...
			'dashicons-arrow-right-alt',           // Menu Icon
			70                                // Menu Position
		);
	...
	public function footer_scripts() {
		$page_hook_id = $this->settings_page_id;
		$confmsg      = esc_html__( 'Are you sure want to do this?', 'redirect-404-error-page-to-homepage-or-custom-page' );
		?>
...
// confirm before reset
	...
	public function add_required_meta_boxes() {
		...
		if ( $this->settings_page_id == $hook_suffix ) {
			...
			add_meta_box(
				...
				esc_html__( 'Save Options', 'redirect-404-error-page-to-homepage-or-custom-page' ),            /* Title */
        ...
        <div id="submitpost" class="submitbox">
            ...
            <div id="major-publishing-actions">
                ...
                <div id="publishing-action">
					...
					<?php submit_button( esc_html__( 'Save', 'redirect-404-error-page-to-homepage-or-custom-page' ), 'primary', 'submit', false ); ?>
                </div>
	...
	public function reset_sanitize( $settings ) {
		...
		if ( ! empty( $settings ) ) {
			add_settings_error( $this->option_group, '', esc_html__( 'Settings reset to defaults.', 'redirect-404-error-page-to-homepage-or-custom-page' ), 'updated' );
			/* Delete Option */
			$this->delete_options();
